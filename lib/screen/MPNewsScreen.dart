...
import 'package:music_podcast/screen/MPNewsDetailScreen.dart';
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        commonCacheImageWidget(data.img, height: 150, width: 230, fit: BoxFit.cover).cornerRadiusWithClipRRect(10),
                        8.height,
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Container(
                  ...
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      commonCacheImageWidget(data.img, height: 50, width: 50, fit: BoxFit.cover).cornerRadiusWithClipRRect(16),
                      16.width,
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
