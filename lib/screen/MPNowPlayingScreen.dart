        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              32.height,
              commonCacheImageWidget(widget.data!.img, height: 360, width: 240, fit: BoxFit.cover).cornerRadiusWithClipRRect(10),
              16.height,
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        commonCacheImageWidget(data.img, height: 100, width: 100, fit: BoxFit.cover).cornerRadiusWithClipRRect(10),
                        4.height,
