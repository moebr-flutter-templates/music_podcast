...
import 'package:music_podcast/screen/MPEditProfileScreen.dart';
import 'package:music_podcast/screen/MPProfileScreen.dart';
import 'package:music_podcast/screen/MPTermsConditionScreen.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Column(
                children: [
                  commonCacheImageWidget(mpImages_2, height: 100, width: 100, fit: BoxFit.cover).cornerRadiusWithClipRRect(50),
                  16.height,
