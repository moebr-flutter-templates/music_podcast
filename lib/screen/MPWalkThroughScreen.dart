...
import 'package:music_podcast/screen/MPSignInAndSignUpScreen.dart';
  ...
  void afterFirstLayout(BuildContext context) {
    pages = [
      Column(
        ...
        children: [
          commonCacheImageWidget(mpImages_1, height: 200, width: 200, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
          16.height,
      ...
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          commonCacheImageWidget(mpImages_2, height: 200, width: 200, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
          16.height,
      ...
      Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          commonCacheImageWidget(mpImages_3, height: 200, width: 200, fit: BoxFit.cover).cornerRadiusWithClipRRect(100),
          16.height,
