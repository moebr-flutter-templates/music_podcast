...
import 'package:music_podcast/utils/percent_indicator/linear_percent_indicator.dart';
    ...
    child: Column(
      ...
      children: [
        LinearPercentIndicator(
          ...
          width:  context.width(),
            lineHeight: 2.0, percent: 0.6, progressColor: mpAppButtonColor),
        4.height,
        Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            commonCacheImageWidget(mpImages_1, height: 50, width: 50, fit: BoxFit.cover).cornerRadiusWithClipRRect(25),
            16.width,
            Column(
